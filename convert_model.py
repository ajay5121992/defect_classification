...
def parse_args(args):
    ...
    parser.add_argument('model_in', help='The model to convert.', default='/home/ajay/PycharmProjects/object_detection/keras-retinanet/keras_retinanet/bin/snapshots/resnet50_csv_10.h5')
    parser.add_argument('model_out', help='Path to save the converted model to.', default='/home/ajay/PycharmProjects/object_detection/keras-retinanet/keras_retinanet/bin')
